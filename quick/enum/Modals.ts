...
export enum ModalsEnum {
    ...
    REPLY_NAME_LABEL = 'Enter Name For Quick Reply',
    REPLY_NAME_PLACEHOLDER = 'Name of Quick Reply',
    REPLY_NAME_INPUT_ACTION = 'reply-name-input-action',
    REPLY_BODY_INPUT = 'reply-body-input',
    REPLY_BODY_LABEL = 'Enter Message For Quick Reply',
    REPLY_BODY_PLACEHOLDER = 'Quick Reply Message',
